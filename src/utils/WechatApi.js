...
export default function initWechatConfig(_jsApiList = []) {
  ...
  const promise = new Promise(function (resolve, reject) {
    ...
    $.ajax({
      type: "GET",
      url: "https://app.playplus.cn/playboom/api/wechatchannel/wxconfig",
      dataType: 'JSON',
      data: {
      ...
      success: function (response) {
        ...
        // return readyHandler(response.data)
        resolve(response);
        Share({
          title: "小怪艾克家庭STEAM美式启蒙",
          desc: "让孩子爱上学习",
          logo: "http://www.playstory.cn/logo.71ba063f.png"
        });
      }
    })
